...
{/* Instantly return some jsx code, so used parentheses instead of curly braces*/}
        ...
        <div className='flex w-full justify-center items-center'>
            <div className='flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4'>
                ...
                <div className='flex flex-col flex-1 items-center justify-start w-full mf:mt-0 mt-10'>
                    <div className='p-3 justify-end items-start flex-col rounded-xl h-48 sm:w-[21rem] w-[75%] my-5 eth-card white-glassmorpism'>
                    ...
                    <div className='p-5 sm:w-96 w-full flex flex-col justify-start items-center purple-glassmorphism'>
                        ...
                        {false ? (
                            ...
                            <button
                                ...
                                className='text-white w-full mt-2 border-[1px] p-2 border-[#63479b] rounded-full cursor-pointer hover:bg-[#8369c9] hover:text-black'
                            >
                                Send Now
                            </button>
                        )}
